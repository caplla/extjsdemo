Ext.define('luter.view.sys.mytree.AllTree', {
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            layout: 'fit',
            items: [
                Ext.create('luter.view.sys.mytree.MyTree')
            ]
        }, {
            title: '同步加载树',
            baseCls: 'home-body',
            ...
            layout: 'fit',
            items: [
                Ext.create('luter.view.sys.mytree.SyncTree')
            ]
        }, {
            title: '全国省市三级',
            baseCls: 'home-body',
            ...
            layout: 'fit',
            items: [
                Ext.create('luter.view.sys.mytree.Regions')
            ]
        }, {
            title: '下拉选择树',
            baseCls: 'home-body',
