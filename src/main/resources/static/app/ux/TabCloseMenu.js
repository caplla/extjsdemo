...
Ext.define('luter.ux.TabCloseMenu', {
    ...
    createMenu: function () {
        ...
        if (!me.menu) {
            var items = [{
                ...
                iconCls:me.closeIcon,
                tooltip:'关闭当前选中的tab页面',
                scope: me,
                handler: me.onClose
            }];
            ...
            if (me.showCloseOthers) {
                items.push({
                    ...
                    iconCls:me.closeOtherIcon,
                    tooltip:'关闭除了当前tab之外的其他所有tab页面',
                    scope: me,
            ...
            if (me.showCloseAll) {
                items.push({
                    ...
                    iconCls:me.closeAllIcon,
                    tooltip:'关闭可以关闭的所有tab页面',
                    scope: me,
