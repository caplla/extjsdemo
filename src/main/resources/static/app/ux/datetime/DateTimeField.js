 ...
 */
Ext.define('luter.ux.datetime.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['luter.ux.datetime.DateTimePicker'],
    ...
    createPicker: function () {
        ...
        return new luter.ux.datetime.DateTimePicker(o);
    },
