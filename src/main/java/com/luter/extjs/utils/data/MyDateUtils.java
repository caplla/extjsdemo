...
public class MyDateUtils {
    ...
    public static int getMinutesBetweenDays(String dateA, String dateB) {
        long dayNumber = 0;
	 ...
	 */
    public static long getMinutesFromNow(String start) throws ParseException

    {
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date d1 = df.parse(MyDateUtils.getStringDate());
     ...
     * @Description:用当前时间作为文件名
     */
    public static String getTimeFileName() throws ParseException
     ...
     * @return
     * @throws ParseException
     * @Title getTimeFolderName
     * @Description TODO
     * @author luter
     * @date 2015-3-9-上午12:54:20
     */
    public static String getTimeFolderName() throws ParseException
    ...
    /**
     * @param @param  longTime 格林威治时间
     * @param @param  dataFormat
     * @param @return 设定文件
     * @return String 返回类型
     * @throws
     * @Title: long2String
     * @Description: 将LONG格式的格林威治时间转换为"yyyy-MM-dd HH:mm:ss"格式
     */
    public static String long2String(long longTimet) {
        Date d = new Date(longTimet);
    ...
    public static String friendlyTime(Date time) {
        //获取time距离当前的秒数
        time = strToDateLong(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(time));
    ...
    public static String getNiceDate(String createTime) {
        String ret = createTime;
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            SimpleDateFormat df1 = new SimpleDateFormat("HH:mm");
            SimpleDateFormat df2 = new SimpleDateFormat("YY年M月d日 HH:mm");
            Date date = sdf.parse(createTime);
            long create = sdf.parse(createTime).getTime();//那个时间
            Calendar now = Calendar.getInstance();
            long ms = 1000 * (now.get(Calendar.HOUR_OF_DAY) * 3600
                    + now.get(Calendar.MINUTE) * 60 + now.get(Calendar.SECOND));// 一天的毫秒数
            long ms_now = now.getTimeInMillis();//现在
            if (ms_now - create < 0) {
                ret = "未来?" + sdf.format(date);
            } else if (ms_now - create < ms) {
                ret = "今天" + df1.format(date);
            } else if (ms_now - create < (ms + 24 * 3600 * 1000)) {
                ret = "昨天" + df1.format(date);
            } else if (ms_now - create < (ms + 24 * 3600 * 1000 * 2)) {
                ret = "前天" + df1.format(date);
            } else {
                ret = df2.format(date);
            }
            return ret;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getNiceDate("2016-01-01 00:15:09"));
    }
}
